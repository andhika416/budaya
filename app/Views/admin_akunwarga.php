...
<div class="flex">
    ...
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="data-panel">
            <h4 class="font-bold mb-4">Data Akun Warga</h4>
            ...
            <!-- Table -->
            <table class="w-full min-w-max border-collapse text-sm [&_td]:border [&_td]:border-slate-200 [&_td]:px-3 [&_td]:py-2 [&_td]:align-middle [&_th]:border [&_th]:border-slate-200 [&_th]:px-3 [&_th]:py-2 [&_th]:align-middle border border-slate-200" id="akunTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?= base_url('admin_akunwarga/delete/' . $user['id_user']) ?>" method="post" onsubmit="return confirm('Yakin ingin menghapus user ini?')">
                                    <?= csrf_field() ?>
                                    <button type="submit" class="inline-flex min-h-10 items-center justify-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold leading-none shadow-sm transition hover:-translate-y-0.5 focus:outline-none focus:ring-4 disabled:cursor-not-allowed disabled:opacity-50 min-h-8 rounded-lg px-3 py-1.5 text-xs bg-red-600 text-white hover:bg-red-700 focus:ring-red-200">Hapus</button>
                                </form>
                            </td>
