            ...
            <div class="form-container bg-light rounded p-4">
                ...
                <form action="/simpan_pemasukan" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="total" name="total" class="form-control" placeholder="Contoh: 5000000" required>
                    </div>

                    <div class="mb-3">
                        <label for="keterangan" class="form-label">Keterangan</label>
                        <textarea id="keterangan" name="keterangan" class="form-control" rows="3" placeholder="Contoh: Iuran warga bulan Mei" required></textarea>
                    </div>
