...
<div class="d-flex">
    ...
    <div class="container">
        <div class="table-wrapper">
            <h4 class="fw-bold mb-4">Data Laporan Warga</h4>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3 mb-2">
                    <input type="text" id="filterLaporan" class="form-control" placeholder="Filter Kata Kunci Laporan" />
                </div>
                <div class="col-md-3 mb-2">
                    ...
                    <?php if (!empty($laporan)) : ?>
                        <?php foreach ($laporan as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('/adminlaporan/hapus/' . $row['id']) ?>" class="btn btn-sm btn-delete" onclick="return confirm('Yakin ingin menghapus laporan ini?')">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
